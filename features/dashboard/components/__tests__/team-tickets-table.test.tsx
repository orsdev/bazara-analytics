...
describe('TeamTicketsTable', () => {
  ...
  it('renders loading skeleton when loading', () => {
    ...
    const { container } = render(<TeamTicketsTable />, { wrapper });
  ...
  it('renders title', () => {
    ...
    render(<TeamTicketsTable />, { wrapper });
    expect(
      screen.getByText('Incident Tickets Assigned to my Team')
    ).toBeInTheDocument();
  });
